...
echo "🚀 [Script Engine] Executing flawless patch-level corrections on clean source..."
...
# =====================================================================
# 2. 严格修复 fs/namespace.c
# =====================================================================
echo "🔧 [Fixing] fs/namespace.c..."

# 2.1 优雅注入全局宏（直接使用标准换行，Actions 环境下不带脏字）
...
# =====================================================================
# 3. 严格修复 fs/proc/task_mmu.c (对齐 goto 拦截)
# =====================================================================
...
# =====================================================================
# 4. 精准修复 kernel/sys.c (严格控制：只改 newuname 的 2 处)
# =====================================================================
...
# 4.2 仅锁定 newuname 作用域，在其内部的 memcpy 后面追加伪装
sed -i '/SYSCALL_DEFINE1(newuname/,/up_read(&uts_sem);/s/memcpy(&tmp, utsname(), sizeof(tmp));/memcpy(\&tmp, utsname(), sizeof(tmp));\n#ifdef CONFIG_KSU_SUSFS_SPOOF_UNAME\n\tif (static_branch_likely(\&susfs_is_uname_spoof_buffer_set))\n\t\tsusfs_spoof_uname(\&tmp);\n#endif/' kernel/sys.c
...
echo "🎉 [Script Engine] Strict pure patch execution finished successfully."
